...
export class Editsection extends Component {
    ...
    handleallchangedata() {
        ...
        console.log(this.state.flag_imgae_detail);
        let details = {};
        let data = {};
        ...
        if (this.state.account_name != "") {
            data = {
                details: details,
                merchant_id: this.props.history.location.state.parent_props
                    .merchant_id,
        ...
        let maindata = {
            data: data,
            check_image_details:this.state.flag_imgae_detail
        };
        console.log(maindata);
        requests
            .postRequest(
                "frontend/test/updateProductdata",
                maindata,
                false,
                false
            )
            .then(response1 => {
                ...
                if (response1.success) {
                    notify.success("Successfully Update Product");
                        this.redirect("/panel/products");
                } else {
    ...
    handleTableChangevariants = variant => {
        ...
        Object.keys(variant).forEach(e => {
            let statechecksku =
                variant[e]["sku"] + variant[e]["source_variant_id"];
            rows.push([
                <span
                ...
                <TextField
                    ...
                    onChange={this.handlechangevalvetextfield.bind(
                        this,
                        "sku",
                        e
                    )}
    ...
    handleDataCheck() {
        requests
            .postRequest("connector/product/getProductById", {
                source_product_id: this.props.history.location.state
                    .parent_props.source_product_id
            })
            .then(data => {
                console.log(data);
                if (!isUndefined(data.data["currentTransaction"])) {
                    this.setState({
                        currentTransaction: data.data["currentTransaction"]
                    });
                }
                ...
                if (!isUndefined(data.data["variant_attribute"])) {
                    this.setState({
                        variant_attribute: data.data["variant_attribute"]
                    });
                }
                if (
                    !isUndefined(data.data["source_marketplace"]) &&
                ...
                if (
                    ...
                    this.state.flag_imgae_detail=1;
                    Object.keys(data.data.details["additional_image"]).forEach(
                        e => {
                            if (
                                !isUndefined(
                                    data.data.details["additional_image"]
                                )
                            ) {
                                temp.img.push(
                                    data.data.details["additional_image"]
                ...
                ) { this.state.flag_imgae_detail=2;
                    Object.keys(data.data.details["additional_images"]).forEach(
                        e => {
                            if (
                                !isUndefined(
                                    data.data.details["additional_images"]
                                )
                            ) {
                                temp.img.push(
                                    data.data.details["additional_images"]
                ...
                if (
                    ...
                    this.setState({
                        product_typemodal: data.data.details.product_type
                    });
                }
                if (
                    ...
                    this.setState({
                        source_product_idmodal:
                            data.data.details.source_product_id
                    });
                }
            });
    }
    handlehtml_editor() {
        this.setState({ show_html_editor: !this.state.show_html_editor });
    }
                            ...
                            <div className="p-5 row">
                                <div className="col-12 mb-3">
                                    ...
                                    <TextField
                                        ...
                                        onChange={this.handleChangetitle.bind(
                                            this
                                        )}
                                ...
                                "" ? null : (
                                    <div className="col-12 mb-3">
                                        {this.state.show_html_editor ===
                                        false ? (
                                            <div className="react_quill_app_class">
                                                <div className="displaytextclsbutton">
                                                    <DisplayText size="large">
                                                        Description
                                                    </DisplayText>
                                                    <div className="showhtml_editorbtn">
                                                        <Button
                                                            onClick={this.handlehtml_editor.bind(
                                                                this
                                                            )}
                                                            primary
                                                        >
                                        ...
                                        <span>
                                            <div className="row p-5 d-flex justify-content-center">
                                                ...
                                                >
                                                    ...
                                                    onClick={this.pressLeftShift.bind(
                                                        this
                                                    )}>
                                                        <img
                                                            style={{
                                ...
                                <div className="col-12 mb-3">
                                    ...
                                    <TextField
                                        ...
                                        onChange={this.handlechangeadditionalimage_url.bind(
                                            this
                                        )}
                                        helpText={
                                            <span>
                                                You can add one or more than one
                                                additional Image but sperated by
                                                Comma(",").
                                            </span>
                                        }
                                        // autoComplete={true}
                                ...
                                <div className="checkflexclsinputfield">
                                    ...
                                    <div className="allproductlabelcsstype">
                                        ...
                                        <TextField
                                            ...
                                            onChange={this.handleChangevendor.bind(
                                                this
                                            )}
                                            className="producttitle"
                                        />
                                ...
                                >
                                    <Modal.Section>
                                        <div className="row">
                                            {Object.keys(
                                                this.state.variantArrayDetails
                                            ).map(e => {
                                                if (
                                                    typeof this.state
                                                        .variantArrayDetails[
                                ...
                                <div className="productupdatebtncls">
                                    ...
                                    <div className="marginpaddingcancelbtn">
                                        <Button
                                            onClick={this.handleallchangedata}
                                            primary
                                        >
                                            Update
                                        </Button>
