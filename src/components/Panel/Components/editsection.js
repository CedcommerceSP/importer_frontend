...
if(newstr!= "" && newstr !== null){
 ...
 this.setState({variant_attribute:data.data["variant_attribute"]});
          ...
          <Modal.Section>
            <div className="row">
              {Object.keys(this.state.variantArrayDetails).map((e) => {
                ...
                {/* <div>
                  <div><Button onClick={this.handleDeltenumber.bind(this)}>-</Button></div>
                  <div><TextField type="text"
                  value={this.state.numveraddfield}

                  />
                  <div><Button onClick={this.handleAddnumber.bind(this)}>+</Button></div>
                  </div>
                </div> */}
              </div>
            </Card>
  ...
  // handleAddnumber(){
  //   this.setState({numveraddfield:this.state.numveraddfield+1})
  // }
  // handleDeltenumber(){
  //   if(this.state.numveraddfield>0){
  //   this.setState({numveraddfield:this.state.numveraddfield-1})
  //   }
  // }
  redirect = (url) => {
